...
volatile uint8_t uart1_received_command = 0;
volatile int16_t uart1_received_value = 0;

volatile uint8_t uart2_receive_count = 0;
volatile uint8_t uart2_receive_buffer[20] = {0};
